...
class ACTSmoothConfig(PreTrainedConfig):
    ...
    # Prefix noise: add Gaussian noise to action prefix embeddings during training.
    # This regularizes the model to be robust to small prefix perturbations,
    # improving continuity when inference prefixes don't exactly match training distribution.
    std_noise_prefix: float = 0.01
