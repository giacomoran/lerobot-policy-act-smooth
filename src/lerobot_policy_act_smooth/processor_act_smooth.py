...
def make_act_smooth_pre_post_processors(
    ...
    """Creates the pre- and post-processing pipelines for the ACTSmooth policy.
    ...
    Args:
        config (ACTSmoothConfig): The ACTSmooth policy configuration object.
